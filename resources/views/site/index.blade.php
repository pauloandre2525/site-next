        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-3 col-sm-6 my-3">
                    <img class="img-fluid img-brand d-block mx-auto" src="assets/img/marcas/fronius-logo.png" alt="..." aria-label="Fronius Logo" />
                </div>
                <div class="col-md-3 col-sm-6 my-3">
                    <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="assets/img/marcas/huawei-logo.png" alt="..." aria-label="Huawei Logo" /></a>
                </div>
                <div class="col-md-3 col-sm-6 my-3">
                    <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="assets/img/marcas/solaredge-logo.png" alt="..." aria-label="Solaredge Logo" /></a>
                </div>
                <div class="col-md-3 col-sm-6 my-3">
                    <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="assets/img/marcas/sungrow-logo.png" alt="..." aria-label="Sungrow Logo" /></a>
                </div>
            </div>
        </div>
    </div>
